...
export const ApiCalibrado = {
  ...
  obtener_cajas_disponibles_byPitahaya:
    LINKROOT + APICALIBRADO + "cajas_disponibles_tipoPitahaya/",
  obtener_liquidaciones: LINKROOT + APICALIBRADO + "obtener_liquidaciones/",
  actualizar_item_liquidacion:
    LINKROOT + APICALIBRADO + "actualizar_item_liquidacion/",
  actualizar_info_liquidacion:
    LINKROOT + APICALIBRADO + "actualizar_info_liquidacion/",
  actualizar_estado_liquidacion:
    LINKROOT + APICALIBRADO + "actualizar_estado_liquidacion/",
};
